...
// limit 3 27Y
  ...
  db.collection('Users').find({age:27}).limit(3).toArray((error , Users)=>{
    ...
    db.collection("Users").updateOne({_id:mongodb.ObjectId("6432b4b3b74fa59e2336c23c")},{
            $set:{name : "Osama" },
            $inc:{age : 4}
          }).
          ...
          db.collection("Users").updateOne({_id:mongodb.ObjectId("6432b4b3b74fa59e2336c23d")},{
            $set:{name : "Ayman" },
            $inc:{age : 4}
          }).
          then((data1)=> {console.log(data1.modifiedCount)})
          .catch((error)=> {console.log(error)})
          db.collection("Users").updateOne({_id:mongodb.ObjectId("6432b4b3b74fa59e2336c23f")},{
            $set:{name : "Ahmed" },
            $inc:{age : 4}
          }).
          then((data1)=> {console.log(data1.modifiedCount)})
          ...
          db.collection("Users").updateOne({_id:mongodb.ObjectId("6432b4b3b74fa59e2336c240")},{
            $set:{name : "Mai"},
            $inc:{age : 4}
          }).
          then((data1)=> {console.log(data1.modifiedCount)})
